...
(function(){
  if ('WebkitTransition' in document.body.style ||
    ...
    document.querySelector('html').className += ' animation'; // TODO: use classList
  }
})();
(function(a) {
  ...
  {
    document.querySelector('html').className += ' mobile'; // TODO: use classList
  }
...
(function() {
  ...
  if (bool) {
    document.querySelector('html').className += ' touch'; // TODO: use classList
  }
})();
